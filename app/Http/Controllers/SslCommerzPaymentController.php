...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = session('session_tottal'); # You cant not pay less than 10
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = uniqid(); // tran_id must be unique

        # CUSTOMER INFORMATION
        $post_data['cus_name'] = session('session_customer_name');
        $post_data['cus_email'] = session('session_customer_email');
        $post_data['cus_add1'] =  session('session_customer_address');

        $post_data['cus_add2'] = "";
        $post_data['cus_city'] =  session('session_customer_city_id');
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] =  session('session_customer_postcode');
        $post_data['cus_country'] =  session('session_customer_country_id');
        $post_data['cus_phone'] =  session('session_customer_phone');
        $post_data['cus_fax'] = "";
