  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{route('To_Honey')}}" class="sl-menu-link @yield('FRONTEND')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">GO TO FRONTEND</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{url('banner')}}" class="sl-menu-link @yield('Banners')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Banners</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{url('index')}}" class="sl-menu-link @yield('Countdown')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Countdown</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{url('client')}}" class="sl-menu-link @yield('Customer')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Customer Comment</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        @if(Auth::User()->role == 1)
        <a href="{{url('Categories')}}" class="sl-menu-link @yield('Categories')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="{{url('Categories/resyclebin')}}" class="sl-menu-link @yield('resyclebin')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-trash tx-20"></i>
            <span class="menu-item-label">Recycle Bin</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{asset('assets/img/img6.jpg')}}" class="wd-32 rounded-circle" alt="">
            </a>
